                    ...
                    <?php if (!empty($bookings)): ?>
                        ...
                        <tr class="booking-row">
                            ...
                            <td>
                                <?php
                                $actions = [
                                    ['type' => 'view', 'icon' => 'fa-eye', 'title' => 'View Details', 'url' => site_url('admin/booking/' . $booking['id'])]
                                ];
                                ...
                                if ($booking['status'] === 'pending') {
                                    ...
                                    if ($paymentComplete) {
                                        $actions[] = ['type' => 'approve', 'icon' => 'fa-check', 'title' => 'Approve Booking', 'onclick' => 'approveBooking(' . $booking['id'] . ')'];
                                    } else {
                                        $actions[] = ['type' => 'approve', 'icon' => 'fa-lock', 'title' => 'Payment Required - Balance: UGX ' . number_format($pendingAmount, 0), 'onclick' => 'showPaymentRequiredAlert(' . $booking['id'] . ', ' . $pendingAmount . ')', 'class' => 'disabled'];
                                    }
                                    $actions[] = ['type' => 'reject', 'icon' => 'fa-times', 'title' => 'Reject', 'onclick' => 'rejectBooking(' . $booking['id'] . ')'];
                                }
                                
                                if ($booking['status'] === 'approved') {
                                    $actions[] = ['type' => 'manage', 'icon' => 'fa-cogs', 'title' => 'Manage Counseling & Admin', 'url' => site_url('admin/booking/' . $booking['id'] . '/manage')];
                                }
                                
                                if (in_array($booking['status'], ['pending', 'approved'])) {
                                    $actions[] = ['type' => 'cancel', 'icon' => 'fa-ban', 'title' => 'Cancel', 'onclick' => 'cancelBooking(' . $booking['id'] . ')'];
                                }
                                ?>
