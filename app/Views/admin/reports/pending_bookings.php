...
<?= $this->include('admin_template/partials/page_header', [
    ...
    'subtitle' => 'Bookings waiting for approval',
    'actions' => $pageActions
]) ?>
...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-actions">
            <span class="badge badge-warning"><?= count($bookings ?? []) ?> Total</span>
        </div>
    </div>
    <div class="card-body">
