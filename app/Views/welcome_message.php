...
<?= $this->section('main_content') ?>
            ...
            <div class="hero-grid">
                ...
                <div class="hero-left">
                    <div class="hero-content">
                        ...
                        <p class="hero-subtitle">
                            Book your perfect wedding venue at Watoto Church campuses across Uganda. 
                ...
                <div class="hero-right">
                    <div class="hero-image">
                        <img src="<?= base_url('images/hero-wedding.jpg') ?>" alt="Wedding at Watoto Church">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select id="venue" name="venue" required>
                                ...
                                <option value="ntinda">Ntinda Campus</option>
                                <option value="nansana">Nansana Campus</option>
    ...
    <section id="venues" class="venues">
        <div class="container">
            <div class="section-header">
                ...
                <p>Choose from our stunning church campuses across Uganda</p>
            </div>
            <div class="venues-grid">
                <div class="venue-card">
                    <div class="venue-image">
                        <img src="<?= base_url('images/downtown-campus.jpg') ?>" alt="Downtown Campus">
                    </div>
                    <div class="venue-info">
                        <h3>Downtown Campus</h3>
                        <p>Our flagship venue in the heart of Kampala</p>
                        <div class="venue-details">
                            <span><i class="fas fa-users"></i> 800 capacity</span>
                            <span><i class="fas fa-car"></i> Parking available</span>
                        </div>
                        <div class="venue-price">From UGX 2,000,000</div>
                    </div>
                </div>

                <div class="venue-card">
                    <div class="venue-image">
                        <img src="<?= base_url('images/ntinda-campus.jpg') ?>" alt="Ntinda Campus">
                    </div>
                    <div class="venue-info">
                        <h3>Ntinda Campus</h3>
                        <p>Modern facilities with elegant architecture</p>
                        <div class="venue-details">
                            <span><i class="fas fa-users"></i> 600 capacity</span>
                            <span><i class="fas fa-car"></i> Parking available</span>
                        </div>
                        <div class="venue-price">From UGX 1,800,000</div>
                    </div>
                </div>

                <div class="venue-card">
                    <div class="venue-image">
                        <img src="<?= base_url('images/nansana-campus.jpg') ?>" alt="Nansana Campus">
                    </div>
                    <div class="venue-info">
                        <h3>Nansana Campus</h3>
                        <p>Serene environment perfect for your special day</p>
                        <div class="venue-details">
                            <span><i class="fas fa-users"></i> 500 capacity</span>
                            <span><i class="fas fa-car"></i> Parking available</span>
                        </div>
                        <div class="venue-price">From UGX 1,500,000</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="about-grid">
                <div class="about-content">
                    <h2>Why Choose Watoto Church?</h2>
                    <p>For over 30 years, Watoto Church has been a place where families are built, lives are transformed, and love stories begin. Our wedding venues provide the perfect sacred space for your special day.</p>
                    ...
                    <div class="about-features">
                        <div class="feature">
                            ...
                            <div>
                                <h4>Sacred Spaces</h4>
                                <p>Beautiful church venues with spiritual significance</p>
                            </div>
                        </div>
                        <div class="feature">
                            <i class="fas fa-heart"></i>
                            <div>
                                ...
                                <p>Dedicated team to make your day perfect</p>
                            </div>
                        </div>
                        <div class="feature">
                            ...
                            <div>
                                ...
                                <p>High-quality facilities and amenities</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="about-image">
                    <img src="<?= base_url('images/about-church.jpg') ?>" alt="About Watoto Church">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="contact" class="contact">
        <div class="container">
            <div class="section-header">
                <h2>Get in Touch</h2>
                <p>Ready to book your dream wedding venue? Contact us today!</p>
            </div>
            <div class="contact-grid">
                <div class="contact-info">
                    ...
                    <div class="contact-item">
                        ...
                        <div>
                            <h4>Address</h4>
                            <p>Plot 64 Kampala Road, Kampala, Uganda</p>
                        </div>
                    </div>
                </div>
